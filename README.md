...
Backend URL (in frontend/lib/features/symptom_check/data/repositories/symptom_repository.dart)
...
│   │   │       └── symptom_check_screen.dart
│   │   │
│   │   ├── onboarding/                   Diet Planner Feature
│   │   │   ├── bloc/                     BLoC (State Management)
│   │   │   │   ├── onboardingBloc.dart
│   │   │   │   ├── onboardingEvent.dart
│   │   │   │   └── onboardingState.dart
│   │   │   ├── models/                   Data models
│   │   │   │   └── diet_plan_model.dart
│   │   │   ├── screens/                 Onboarding UI flow
│   │   │   │   ├── IntroductoryPage.dart
│   │   │   │   ├── GoalSelectionPage.dart
│   │   │   │   ├── ActivityLevelPage.dart
│   │   │   │   ├── TargetWeightPage.dart
│   │   │   │   ├── DietTypePage.dart
│   │   │   │   ├── MedicalDietPage.dart
│   │   │   │   ├── AllergyPage.dart
│   │   │   │   ├── CuisinesPage.dart
│   │   │   │   ├── OnboardingCompletePage.dart
│   │   │   │   ├── DailyMealPage.dart
│   │   │   │   ├── WeeklyPagePlan.dart
│   │   │   │   └── OnboardingWrapper.dart
...
│   │       ├── session_service.dart    Singleton session manager
│   │       └── test_session_service.dart Testing utilities
│   │
